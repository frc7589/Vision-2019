...
gst-launch-1.0 v4l2src device=/dev/video3 ! video/x-raw,width=1024,height=576 ! videoflip method=rotate-180 \
! omxh264enc bitrate=300000 ! 'video/x-h264, stream-format=(string)byte-stream' ! queue max-size-buffers=0 ! h264parse ! rtph264pay ! udpsink host=10.75.89.255 port=5803
